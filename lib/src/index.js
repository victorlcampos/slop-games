...
//   records  → the three games that kept a best score, and the bug two of them
//              wrote into it (see records.js)
...
export { createRecords, freshRecord, normalizeRecord, mergeRecord } from './records.js';
