...
export const dict = {
  ...
  'menu.touch': {
    pt: 'No celular: os comandos aparecem na tela e o tiro é o botão da direita.',
    en: 'On a phone: the controls are drawn on screen and the trigger is the right-hand button.',
  },
  'menu.aim': {
